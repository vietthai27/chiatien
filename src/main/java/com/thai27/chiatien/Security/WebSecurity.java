package com.thai27.chiatien.Security;
...
//						.requestMatchers("/bank/**").hasAnyAuthority("ADMIN","MODER")
						.requestMatchers("/user/auth/admin/**").hasAuthority("ADMIN")
	...
	CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("http://localhost:3000", "https://trang-tin-tuc-v5-fe.onrender.com"));
